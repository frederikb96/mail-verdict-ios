    ...
    /// Dynamic Type text styles for the list row and reader chrome. No fixed point sizes
    /// anywhere: every value here is a system text style, so Dynamic Type follows through
    /// automatically.

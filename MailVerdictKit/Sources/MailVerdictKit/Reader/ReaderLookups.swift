...
/// calendars and identities — fetched once per reader and shared by every page. A failed fetch is
/// not remembered, so the next page asking tries again.
@MainActor
